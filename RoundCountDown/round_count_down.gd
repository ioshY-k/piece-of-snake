...
var container_anim_dict = {
	...
	str(GameConsts.MAP_MODS.TAILVIRUS) : load("res://RoundCountDown/NoMapMod/container_animations.tscn"),
	str(GameConsts.MAP_MODS.EDIBLE_PAPER) : load("res://RoundCountDown/NoMapMod/container_animations.tscn"),
	str(GameConsts.MAP_MODS.LASER) : load("res://RoundCountDown/NoMapMod/container_animations.tscn"),
	...
	str(GameConsts.MAP_MODS.ANTI_MAGNET) : load("res://RoundCountDown/NoMapMod/container_animations.tscn"),
	str(GameConsts.MAP_MODS.GHOST_INVASION) : load("res://RoundCountDown/NoMapMod/container_animations.tscn"),
	str(GameConsts.MAP_MODS.FAR_AWAY) : load("res://RoundCountDown/NoMapMod/container_animations.tscn"),

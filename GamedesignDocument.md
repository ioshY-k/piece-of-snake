...
- Selecting an upgrade may unlock **advanced versions** of this upgrade in future upgrade pools.
- Upgrades are categorized by function or effect. These categories may influence synergy interactions.
- There are limited slots for each Upgrade category
- An Upgrade may be bought onto an occupied slot for a cheaper price, thus removing the previous Upgrade at that place
---

...
func _ready() -> void:
	...
	level.current_map.position = level.map_fourth_pos_and_scale[level.current_map_index][0]
	level.current_map.scale = level.map_fourth_pos_and_scale[level.current_map_index][1]

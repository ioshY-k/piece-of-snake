...
func get_map_data0(map: int):
	match map:
		...
		GameConsts.MAP_LIST.TRAIN:
			return [Vector2(-367.0,-578.0), Vector2(1.007,0.962), Vector2i(16,14), Vector2i(0,0), Vector2i(17,15)]
...
func get_map_data1(map: int):
	match map:
		...
		GameConsts.MAP_LIST.TRAIN:
			return [Vector2(-292.0,-504.0), Vector2(0.949,0.898), Vector2i(17,15), Vector2i(-1,-1), Vector2i(17,15)]
...
func get_map_data2(map: int):
	match map:
		...
		GameConsts.MAP_LIST.TRAIN:
			return [Vector2(-293.0,-506.0), Vector2(0.896,0.842), Vector2i(18,16), Vector2i(-1,-1), Vector2i(18,16)]
...
func get_map_scene(map:int):
	match map:
		...
		GameConsts.MAP_LIST.TRAIN:
			return preload("res://Levels/TrainMap/train_map.tscn")

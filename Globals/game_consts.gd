...
enum MAP_MODS {NO_MAPMOD, CAFFEINATED, TAILVIRUS, EDIBLE_PAPER,
	LASER, FRUIT_BODY, TETRI_FRUIT, MOVING_FRUIT, ANTI_MAGNET, GHOST_INVASION,
	FAR_AWAY, DARK, UFO, HEAD_SWAP, SLIME_TRAIL}
...
enum UPGRADE_LIST {	AREA_SIZE_1, AREA_SIZE_2, AREA_SIZE_3,
					...
					FRUIT_AREA_1, FRUIT_AREA_2, FRUIT_AREA_3,
					HIT_ACTION, GHOST_FRUIT_REACTION, INSECT_REACTION, SHRINK_REACTION, INSECT_ACTION, ACTIVE_ITEM_ACTION,
					CARNIVORE}
...
var advanced_upgrades: Array[int] = [	UPGRADE_LIST.AREA_SIZE_2, UPGRADE_LIST.AREA_SIZE_3,
										...
										UPGRADE_LIST.TONGUE_2, UPGRADE_LIST.TONGUE_3,
										UPGRADE_LIST.FRUIT_AREA_2, UPGRADE_LIST.FRUIT_AREA_3,]
...
var upgrades_with_advancement: Array[int] = [	UPGRADE_LIST.AREA_SIZE_1, UPGRADE_LIST.AREA_SIZE_2,
												...
												UPGRADE_LIST.TONGUE_1, UPGRADE_LIST.TONGUE_2,
												UPGRADE_LIST.FRUIT_AREA_1, UPGRADE_LIST.FRUIT_AREA_2,]
...
func get_upgrade_type(upgrade_id: int):
	...
	match upgrade_id:
		...
		UPGRADE_LIST.FRUIT_AREA_1, UPGRADE_LIST.FRUIT_AREA_2, UPGRADE_LIST.FRUIT_AREA_3,\
		UPGRADE_LIST.HIT_ACTION, UPGRADE_LIST.INSECT_ACTION, UPGRADE_LIST.ACTIVE_ITEM_ACTION,\
		UPGRADE_LIST.GHOST_FRUIT_REACTION, UPGRADE_LIST.INSECT_REACTION, UPGRADE_LIST.SHRINK_REACTION:
		...
		UPGRADE_LIST.TONGUE_1, UPGRADE_LIST.TONGUE_2, UPGRADE_LIST.TONGUE_3,\

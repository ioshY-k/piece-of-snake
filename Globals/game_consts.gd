...
enum CHAR_LIST {GODOT, PYTHON, SALAMANDER, CHAMELEON, ELEPHANT}

enum MAP_LIST {WOODS,STADIUM,OFFICE,CAVE,DISCO,BEACH,RESTAURANT,TOMB, TRAIN}

enum MAP_MODS {CAFFEINATED, TAILVIRUS, EDIBLE_PAPER, LASER, FRUIT_BODY, TETRI_FRUIT, MOVING_FRUIT, ANTI_MAGNET, GHOST_INVASION, FAR_AWAY, DARK}
...
var FRUIT_THRESHOLDS: Array [int] = [9,9,9,9, 10,10,10,10, 11,11,11,11]
const ROUND_TIME_SEC: int = 75

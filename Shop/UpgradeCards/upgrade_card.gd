...
var upgrade_descriptions = {
	...
	str(GameConsts.UPGRADE_LIST.FUEL_1) : "[color=ffc875]Collecting a fruit while in Hyperspeed[/color] has a 3 in 4 chance to grant an additional point, as long as your Hyperspeed gauge is more than half empty.",
	str(GameConsts.UPGRADE_LIST.FUEL_2) : "[color=ffc875]Collecting a fruit while in Hyperspeed[/color] has a 3 in 4 chance to grant an additional point and no growth, as long as your Hyperspeed gauge is more than half empty.",
	str(GameConsts.UPGRADE_LIST.FUEL_3) : "[color=ffc875]Collecting a fruit while in Hyperspeed[/color] always grants an additional point and no growth, as long as your Hyperspeed gauge is more than half empty.",
	...
	str(GameConsts.UPGRADE_LIST.BIG_FRUIT_1) : "Fruits are [color=ffc875]bigger[/color] and won't move, except moving towards you",
	str(GameConsts.UPGRADE_LIST.BIG_FRUIT_2) : "Fruits are [color=ffc875]even bigger[/color] and won't move, except moving towards you",
	str(GameConsts.UPGRADE_LIST.BIG_FRUIT_3) : "Fruits have [color=ffc875]ridiculous size[/color] and won't move, except moving towards you",

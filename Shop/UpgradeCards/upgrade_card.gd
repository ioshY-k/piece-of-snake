...
var upgrade_descriptions = {
	...
	str(GameConsts.UPGRADE_LIST.BIG_FRUIT_1) : "Fruits are [color=ffc875]bigger[/color] and won't move",
	str(GameConsts.UPGRADE_LIST.BIG_FRUIT_2) : "Fruits are [color=ffc875]even bigger[/color] and won't move",
	str(GameConsts.UPGRADE_LIST.BIG_FRUIT_3) : "Fruits have [color=ffc875]ridiculous size[/color] and won't move",
